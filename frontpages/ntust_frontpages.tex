...
%\makebox[8cm][s]{\textbf{\Huge{\degreeCname 論文}}}\\ %顯示論文種類 (中文)
\vspace{1cm}
%
...
\includepdf[fitpaper=true,scale=1,angle=90]{frontpages/img-122151630-0001.pdf}
%\includepdf[fitpaper=true,scale=1]{frontpages/D9505501_Doctor3151843.pdf}
...
\newpage{\thispagestyle{empty}}
\includepdf[fitpaper=true,scale=1,angle=90]{frontpages/img-122151618-0001.pdf}
%\includepdf[fitpaper=true,scale=1]{frontpages/D9505501_Doctor615182.pdf}
...
\makebox[3cm][s]{\normalsize{學生：}}
\makebox[2.5cm][l]{\normalsize{\myCname}} \\ %學生中文姓名

\makebox[3cm][s]{\normalsize{指導教授：}}
\makebox[2.5cm][l]{\normalsize{\advisorCnameA}} \\ %教授A中文姓名
...
% each text field occupies the same width
\makebox[1.7cm][s]{\normalsize{Student: }}
\makebox[4cm][l]{\normalsize{\myEname}} \\ %學生英文姓名
%\hfill
%
\makebox[1.7cm][s]{\normalsize{Advisor: }}
\makebox[4cm][l]{\normalsize{\advisorEnameA}} \\ %教授A英文姓名
%
% 判斷是否有共同指導的教授 B
\ifx \advisorCnameB  \itsempty
\relax % 沒有 B 教授，所以不佔版面，不印任何空白
