...
\documentclass[13pt, a4paper,twoside,openright]{ntust_report} 

\usepackage{fontspec}   %加這個就可以設定字體 
\usepackage{xeCJK}       %讓中英文字體分開設置 
\setmainfont[Mapping=tex-text]{Times New Roman}            %設定主要字型，也就是英文字型 
\setCJKmainfont[AutoFakeBold=3.5]{Kaiti TC Regular}     %設定中文字型 
...
\begin{document}
	...
	\input{sections/aseicmic-ability.tex}
	\input{sections/crack-component.tex}
	\input{sections/retrofit-cost.tex}
